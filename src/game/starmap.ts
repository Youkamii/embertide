...
export const STAR_MAP: readonly MapSystem[] = [
  ...
  sys('폴룩스', 33.8, 113, 185, 'sun', [1.8, 1.15, 0.55],
    '쌍둥이자리의 주황 거성. 행성을 가진 별 중 가장 밝았다.', {
      planets: [{ name: '테스티아스', r: 12, orbMul: 3.1, log: '폴룩스 b — 목성보다 두 배 무거운 것.' }],
    }),
  ...
  sys('백조자리 X-1', 6070, 63, 300, 'core', [0.9, 0.7, 1.2],
    '인류가 처음 확신한 블랙홀 — 동족이다. 푸른 초거성의 살을 뜯고 있었다.', {
      companions: [{ name: 'HDE 226868', r: 720, orbMul: 4.5, log: '블랙홀에게 뜯기던 청색 초거성.' }],
    }),
...
export const HOLES: readonly { name: string; r: number; x: number; y: number; z: number; log: string }[] = [
  { ...at(1560, 252, '가이아 BH1'), name: '가이아 BH1', r: 90, log: '태양에서 가장 가까운 블랙홀. 첫 동족.' },
  { ...at(1926, 57, '가이아 BH3'), name: '가이아 BH3', r: 210, log: '은하수 항성질량 블랙홀 중 최대급.' },
  { ...at(3800, 215, '가이아 BH2'), name: '가이아 BH2', r: 110, log: '적색거성을 곁에 둔 조용한 것.' },
  { ...at(4700, 150, 'V616 모노케로티스'), name: 'V616 모노케로티스', r: 100, log: '오래 "가장 가까운 블랙홀"이라 불리던 것.' },
  { ...at(7800, 63, 'V404 백조자리'), name: 'V404 백조자리', r: 140, log: '1989년과 2015년, 두 번 폭발한 것.' },
  { ...at(11000, 265, 'GRO J1655-40'), name: 'GRO J1655-40', r: 130, log: '우주를 초속 백 킬로미터로 달리는 마이크로퀘이사.' },
]
